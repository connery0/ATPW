package
{
	...
	public class Bartering_mc extends Character
	{
		...
		override protected function setDialog()
		{
			...
			dialog = [	new Dialog(T, "OI, you need a drink?"),
						new Dialog(P, "Yes, all the drinks"),
						new Dialog(T, "I just sold those to the thing next to you, go fight him to the death to get them")
						];
		}
	}
