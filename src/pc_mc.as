	...
	public class Pc_mc extends Character
	{
		...
		override protected function setDialog() {
				...
				dialog = [		new Dialog(T, "---[1] Article available for viewing: [Newspaper: The Philosopher] [Author: Elin DeCarti] [Uploaded: Yor 34, SR / Hura67 / Minu21 / Secu95] “Nihilism continues to gorge on YiYa Model”---"),
								...
								new Dialog(T," Debate has ripped apart the Pantheon on the next course of action.\n“The Faithfar faction has swelled in numbers, yet Zeu’s support of the Agananta party still keeps the Gods in a conservative position.” says resident theo-analyst Anthony Gurringstok. “It might just be the perfect breeding ground for a mutiny, perhaps one bigger than Udynea’s Abdication.”" ),
